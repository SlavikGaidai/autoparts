...
function bottom_navbar() {
  return ` <!---------------------------------------------->
    ...
    <div id="bottom_nav" class="bottom_nav">
        ...
        <a href="/products.html?category=Зовнішні деталі">Зовнішні деталі</a>
        <a href="/products.html?category=Внутрішні деталі">Внутрішні деталі</a>
        <a href="/products.html?category=Шини%20та%20диски">Шини та диски</a>
        <a href="/products.html?category=Запчастини">Запчастини</a>
        <a href="/products.html?category=Електроніка">Електроніка</a>
        <a href="/products.html?category=Інструменти">Інструменти</a>
